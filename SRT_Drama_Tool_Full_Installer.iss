; ============================================================================
; Full offline installer for SRT Drama Tool
; ============================================================================
...
#define SourceDir "dist\SRT Drama Tool Full"

[Setup]
AppId={{A1B2C3D4-E5F6-7890-ABCD-EF1234567890}
AppName={#MyAppName}
AppVersion={#MyAppVersion}
AppVerName={#MyAppName} v{#MyAppVersion} Full Offline
AppPublisher={#MyAppPublisher}
AppPublisherURL={#MyAppURL}
AppSupportURL={#MyAppURL}
AppUpdatesURL={#MyAppURL}
VersionInfoVersion=1.1.5.0
VersionInfoDescription=Professional SRT Subtitle and Voice Tool with bundled AI dependencies
...
OutputBaseFilename=SRT_Drama_Tool_Full_Setup
